  ...
  return (
    <div className="container">
      ...
      <form className="form">
        ...
        <div className="my-2">
          <button onClick={() => setVisible(!isVisible)} type="button" className="btn btn-light">
        ...
        <input label="SAVE" type="submit" value="Create" onClick={e => handleSubmit(e)} className="btn btn-primary my-1" />
